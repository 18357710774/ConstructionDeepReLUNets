...
nBP_3channel_opt = [100 150 200 190 200 200 190 200;
                    140 170 180 180 180 200 180 200
                    130 200 200 200 200 200 190 200];
epochsBP_3channel_opt = [10000 10000 2000 5000 5000 5000 5000 5000;
                         10000 10000 5000 5000 5000 5000 5000 3000;
...
for ii = 1:ExNum
    ...
    save([cd '\results\RadarResults\Contrast_RiverIce20150417_223028_MissValColor_200x225_Numerical.mat'],...
            ...
            'predict_y_ND_3channel', 'ImgRecovery_ND', 'I_400x450_normal', 'I_200x225_normal',...
