...
for epsilon = epsilonCross
    for gamma = gammaCross
        for c = cCross
            ...
            imwrite(I,[cd '\results\RadarResults\SVRepsRBF_' name '_200x225_2ResColor_eps ' num2str(epsilon) 'gamma' num2str(gamma) 'c' num2str(c) '.jpg'],'jpg')
...
save([cd '\results\RadarResults\SVRepsRBF' name '_200x225_2ResColor' num2str(resolution) '.mat'],...
