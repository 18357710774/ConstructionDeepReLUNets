...
nBP_opt = [200 200 200 200 200 200 200 200];
epochsBP_opt = [10000 10000 5000 5000 5000 5000 5000 5000];
...
for ii = 1:ExNum
    ...
    save([cd '\results\RadarResults\Contrast_RadarData20201009135112_MissingVal_167x225_Numerical.mat'],...
        ...
        'predict_y_ND', 'ImgRecovery_ND', 'I_334x450_normal', 'I_167x225_normal',...
