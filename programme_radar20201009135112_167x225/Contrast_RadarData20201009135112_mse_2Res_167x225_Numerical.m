...
nBP_opt = [180 80 200 200 200 200 200 200 200 200 190];
epochsBP_opt = [10000 10000 10000 10000 5000 4000 5000 5000 5000 5000 5000];
...
save([cd '\results\simulation3\Contrast_RadarData20201009135112_mse_2Res_167x225_Numerical.mat'],...
        ...
        'predict_y_ND', 'predict_yTensor_ND', 'I_334x450_normal', 'I_167x225_normal',...
