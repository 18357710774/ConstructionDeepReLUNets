...
load([cd '\results\RadarResults\Contrast_RadarData20201009135112_mse_2Res_167x225_Numerical.mat'])
load([cd '\results\RadarResults\Adaboost_Yhat_20201009135112_167x225.mat'])
[m, n] = size(I_334x450_normal);
