...
for uu = 1:length(BPMethodCross)
    ...
    colormap(jet);
    saveas(1, [cd '\results\simulation3\figs\' method '_GridTrainGridTestEx' num2str(SelExNum) '.fig'])
    close;
...
colormap(jet);
saveas(1, [cd '\results\simulation3\figs\BPSGD_GridTrainGridTestEx' num2str(SelExNum) '.fig'])
close;
...
colormap(jet);
saveas(1, [cd '\results\simulation3\figs\SVR_GridTrainGridTestEx' num2str(SelExNum) '.fig'])
close;
...
colormap(jet);
saveas(1, [cd '\results\simulation3\figs\ND_GridTrainGridTestEx' num2str(SelExNum) '.fig'])
close;

fprintf(['ND  N_star#' num2str(N_star_opt) ': mse is ' num2str(mse_ND) ...
'   time cost is ' num2str(t_ND) '\n']);    

save([cd '\results\simulation3\Contrast_GridTrainGridTestIllustrationSelExNum17TrainNum40000.mat'],...
