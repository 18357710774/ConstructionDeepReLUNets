...
# Simulate data
fileload = str_c(pathtmp,"\\SyntheticData\\GridTrainGridTestSamples40000.Rdata")
filesave = str_c(pathsave,"AdaboostGridTrainGridTestNumericalReusltsGridNum200.Rdata")
...
mse_adaboost = matrix(0, t_num, ntreesAddTotalTimes)
tt <- 1
  ...
  ############### generate orange datasets ####################
{
  ...
  add_count <- 1
  print(paste0("Ex", tt, "  add_count", add_count, "  mse: ", mse_adaboost[tt, 1], "  Time cost: ",t[3][[1]],"  seconds"))
  ...
  while(add_count<ntreesAddTotalTimes)
  {
    ...
    print(paste0("Ex", tt, "  add_count", add_count, "  mse: ", mse_adaboost[tt, add_count],
                 "  Time cost: ",t[3][[1]],"  seconds"))
  }
  # plot(1:ntreesAddTotalTimes, mse_adaboost[tt, ], type = "l", col="red")
  tt <- tt+1
}
...
Adaboost_results = list(ntreesIniNum = ntreesIniNum, ntreesAddNum = ntreesAddNum, ntreesAddTotalTimes = ntreesAddTotalTimes, 
                        ExNum = t_num, mse_adaboost = mse_adaboost, mse_adaboost_Mean = mse_adaboost_Mean,
