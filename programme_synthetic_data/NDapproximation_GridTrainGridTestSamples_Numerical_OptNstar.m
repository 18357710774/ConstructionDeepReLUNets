...
save([cd '\results\simulation3\NDGridTrainGridTestSamplesNumericalReusltsGridNum' num2str(GridNum_train) 'OptNstar.mat'], ...
        'd','GridNum_test','GridNum_train','Ind_S', 'm', 'mse_ND', 't_ND', 'predict_y_ND',...
        'N_star_Opt', 'r', 'RadeRV', 's', 'tau','U');