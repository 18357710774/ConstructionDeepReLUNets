...
%                 mse_SVRepsRBF1(vv, uu) = mse(test_y-hat_y);
    ...
    save([cd '\results\simulation3\SVRepsRBFGridTrainGridTestSamplesNumericalEx' num2str(Ex) 'TrainNum' num2str(m_train) '.mat'],...
        'd','e','m_test','GridNum_test','Ind_S', 'IndRand', 'm_train','GridNum_train', 't_SVRepsRBF', 'mse_SVRepsRBF', 'epsilonCross', 'ExNum',...
