...
for Ex = 1:ExNum
    ...
    save([cd '\results\simulation3\BPBFGGridTrainGridTestSamplesNumericalEx' num2str(Ex) 'TrainNum' num2str(m_train) '.mat'],...
        'd','e','m_test','GridNum_test','Ind_S', 'IndRand', 'm_train','GridNum_train', 't_BPBFG', 'mse_BPBFG', 'epoches_Cross', 'ExNum',...
