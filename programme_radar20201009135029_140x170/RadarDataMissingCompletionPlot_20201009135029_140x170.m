...
load([cd '\results\RadarResults\Contrast_RadarData20201009135029_MissingVal_140x170_Numerical.mat'])
load([cd '\results\RadarResults\ImgRecovery_Ada_140x170.mat'])
[m, n] = size(I_140x170_normal);
