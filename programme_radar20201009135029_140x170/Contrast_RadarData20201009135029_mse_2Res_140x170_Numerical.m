...
nBP_opt = [20 60 140 200 190 190 200 190 190 190 200];
epochsBP_opt = [10000 8000 10000 10000 5000 5000 5000 5000 5000 5000 5000];
...
save([cd '\results\simulation3\Contrast_RadarData20201009135029_mse_2Res_140x170_Numerical.mat'],...
        ...
        'predict_y_ND', 'predict_yTensor_ND', 'I_280x340_normal', 'I_140x170_normal',...
