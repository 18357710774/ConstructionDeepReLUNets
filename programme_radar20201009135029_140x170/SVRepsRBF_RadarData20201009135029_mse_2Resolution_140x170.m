...
epsilonCross =  [0.01 0.1]; % [0.001 0.01 0.1];
gammaCross = 10000; % [0.01 0.1 1 10 100 1000];
...
%                 mse_SVRepsRBF1(vv, uu) = mse(test_y-hat_y);
    ...
    save([cd '\results\RadarResults\SVRepsRBF' name '_140x170_Res' num2str(resolution) '_2.mat'],...
