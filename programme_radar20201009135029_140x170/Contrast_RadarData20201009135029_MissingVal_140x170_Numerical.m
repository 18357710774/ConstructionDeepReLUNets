...
nBP_opt = [130 200 200 170 200 200 200 200];
epochsBP_opt = [10000 10000 4000 5000 5000 5000 5000 4000];
...
for ii = 1:ExNum
    ...
    save([cd '\results\RadarResults\Contrast_RadarData20201009135029_MissingVal_140x170_Numerical.mat'],...
        ...
        'predict_y_ND', 'ImgRecovery_ND', 'I_280x340_normal', 'I_140x170_normal',...
