...
pathtmp = "C:\\Users\\admin\\Desktop\\¡ıœº\\code\\SyntheticData\\"
# savefile = str_c(pathtmp,"GridTrainGridTestSamples40000.Rdata")
savefile = str_c(pathtmp,"GridTrainGridTestSamplesHnoise40000.Rdata")
