...
for nBP = nBP_Cross
    for epochs = epoches_Cross
        ...
        imwrite(I,[cd '\results\RadarResults\BPGDM_' name '_200x150_2ResColor_nBP ' num2str(nBP) 'epo' num2str(epochs) '.jpg'],'jpg')
...
save([cd '\results\RadarResults\BPGDM_' name '_200x150_2ResColor.mat'],...
