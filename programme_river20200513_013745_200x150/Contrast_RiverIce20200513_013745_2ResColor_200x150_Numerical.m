...
nBP_3channel_opt = [10 40 70 170 190 160 190 200 200 200 170;
                    20 60 150 110 190 190 180 200 200 180 190;
                    10 70 170 190 200 200 180 200 160 190 200];
epochsBP_3channel_opt = [10000 8000 8000 8000 2000 4000 2000 4000 5000 5000 5000;
                         8000 10000 8000 10000 3000 3000 5000 5000 5000 4000 4000;
                         10000 10000 8000 10000 5000 5000 5000 5000 5000 5000 3000];
...
% SVR_C_3channel_opt = [10000;10000;100];
...
% ND_method的最优参数
tau = 0.0001;
N_star_3channel_opt = [100;150;150];
...
predict_yTenosr_SVR_3channel = zeros(size(I_400x300_normal));

t_ND_3channel = zeros(3, 1);
mse_ND_3channel = zeros(3, 1);
predict_y_ND_3channel = cell(3, 1);
predict_yTensor_ND_3channel = zeros(size(I_400x300_normal));


% BP methods
for uu = 1:length(BPMethodCross)
    method = BPMethodCross{uu};   
    Itmp = zeros(size(I_400x300_normal));
    for  ii = 1:3
...
save([cd '\results\simulation3\Contrast_RiverIce20200513_013745_2ResColor_200x150_Numerical.mat'],...
        ...
        'predict_y_ND_3channel', 'predict_yTensor_ND_3channel', 'I_400x300_normal', 'I_200x150_normal',...
