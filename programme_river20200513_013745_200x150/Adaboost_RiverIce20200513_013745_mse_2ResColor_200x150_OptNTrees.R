...
filesave = str_c(pathsave,"Adaboost_RiverIce20200513_013745_mse_color_200x150_Res2OptTreesNum.Rdata")

load(fileload)

ntrees_opt_3channel = c(9390, 9340, 9180)

mse_opt_3channel = numeric(3)
t_opt_3channel = numeric(3)
Yhat_opt_3channel = matrix(0, 120000, 3)
