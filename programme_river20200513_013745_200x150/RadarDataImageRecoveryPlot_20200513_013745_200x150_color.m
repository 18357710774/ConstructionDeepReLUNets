...
load([cd '\results\RadarResults\Contrast_RiverIce20200513_013745_2ResColor_200x150_Numerical.mat'])
load([cd '\results\RadarResults\Adaboost_Yhat_20200513_013745_200x150_Color.mat'])
[m, n, channel] = size(I_400x300_normal);
